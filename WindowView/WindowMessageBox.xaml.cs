...
namespace MouseKeyboardSpirit.WindowView
{
    ...
    /// 互動邏輯
    /// </summary>
    public partial class WindowMessageBox : Window, INotifyPropertyChanged
    {
        ...
        public WindowMessageBox(string title, string content, MessageBoxWindowShowType showtype, MessageBoxWindowButtonType buttontype)
        {
            try
            {
                InitializeComponent();
